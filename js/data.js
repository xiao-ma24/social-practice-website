    ...
    points: [
      {
        ...
        surveyAreas: [
          { name: '中山桥周边', description: '黄河文化 · 城市记忆 · 百年铁桥', image: 'https://picsum.photos/seed/zhongshan-bridge/600/400',
            intro: '中山桥是黄河上第一座真正意义上的桥梁，始建于清光绪三十三年（1907年），被誉为"天下黄河第一桥"。桥体为钢桁架结构，横跨黄河两岸，连接白塔山与兰州城区，是兰州百年城市变迁的见证者。',
            process: '我们沿中山桥步行至白塔山公园，实地考察桥体结构与周边文化景观。在桥头采访了两位本地老人，他们讲述了中山桥从"镇远桥"到"中山桥"的历史沿革，以及桥两岸从滩涂到繁华街区的变迁。登白塔山俯瞰黄河全景，记录桥体与城市天际线的关系。',
            feeling: '站在百年铁桥上，脚下黄河奔流不息。老人们讲述时眼中闪着光——一座桥不仅是钢筋铁骨，更是几代人的记忆锚点。铆钉斑驳处，藏着兰州人跨越世纪的足迹。'
          },
          { name: '正宁路夜市', description: '饮食文化 · 市井烟火 · 街市生活', image: 'https://picsum.photos/seed/zhengning-market/600/400',
            intro: '正宁路夜市是兰州最富盛名的美食街区，汇聚了兰州牛肉面、灰豆子、甜醅、酿皮等百余种地方小吃。夜市不仅是美食集市，更是兰州人生活方式和市井文化鲜活的集中体现。',
            process: '傍晚六点夜市开市，我们沿街走访十几家摊位，重点采访了经营三十余年的"老马家牛奶鸡蛋醪糟"和网红摊位"放哈咖啡"。摊主们分享了夜市从自发集市到规范化管理的发展历程，以及疫情后客流恢复情况。',
            feeling: '夜市是城市最真实的切片。炭火、叫卖、碗筷碰撞——这些声音比任何课本都生动。一位摊主说"一碗面就是一座城"，我们忽然懂了——市井烟火中，藏着最鲜活的文化传承。'
          },
          { name: '甘肃省博物馆', description: '历史文物 · 丝路文明 · 彩陶文化', image: 'https://picsum.photos/seed/gansu-museum/600/400',
            intro: '甘肃省博物馆是国家一级博物馆，馆藏文物逾35万件，以丝绸之路文物、彩陶、汉简、佛教艺术为特色。镇馆之宝"铜奔马"（马踏飞燕）是中国旅游标志，也是丝路文化交流的不朽象征。',
            process: '我们重点参观了"丝绸之路文明展"和"甘肃彩陶展"两个常设展厅，拍摄记录了铜奔马、汉代简牍、唐三彩等代表性文物。采访了社教部工作人员，了解博物馆在非遗保护和青少年教育方面的工作。',
            feeling: '走进展厅仿佛穿越千年丝路。铜奔马的轻盈姿态让人屏息，汉代简牍上的墨迹仍清晰可辨。博物馆不是文物的仓库，而是一座让历史发声的剧场——每一件展品都在讲述丝路的故事。'
          }
        ],
        heritageItems: [
          { name: '牛肉面制作技艺', level: '国家级非遗', description: '一清二白三红四绿五黄，手工拉制七种面型，被誉为"中华第一面"。', image: 'https://picsum.photos/seed/heritage-beefnoodle/400/300', icon: '🍜',
            intro: '兰州牛肉面制作技艺以"一清（汤清）二白（萝卜白）三红（辣椒红）四绿（蒜苗绿）五黄（面黄）"为品质标准。手工拉制七种面型：毛细、细面、二细、三细、韭叶、宽面、大宽，每种面型口感各异，体现了兰州人对一碗面的极致追求。',
            process: '清晨五点，我们来到五泉山附近的"磨沟沿老字号牛肉面"后厨。传承人演示了从和面、揉面、溜面、拉面到煮面的完整流程。我们尝试拉面——面团在手中完全不听使唤，拉出来的面条粗细不匀，有的断成几截。师傅手把手纠正我们的手势和发力角度。',
            feeling: '一碗面从案板到碗中不过两分钟，背后却是数十年的功夫。我们拉的面虽然失败，师傅却说"面是活的，早晚会听你的话"。这句朴素的话让我们理解了什么叫匠人精神——不是惊天动地，而是日复一日地做好一件事。'
          },
          { name: '兰州皮影戏', level: '省级非遗', description: '牛皮雕刻，灯影千姿，唱腔独特，是西北民间艺术的瑰宝。', image: 'https://picsum.photos/seed/heritage-piying/400/300', icon: '🎭',
            intro: '兰州皮影戏以牛皮为原料，经雕刻、上色、装订等多道工序制作皮影人物。演出时艺人在白色幕布后操纵皮影，配合地方唱腔和乐器，演绎历史故事和民间传说，是西北民间艺术的瑰宝。',
            process: '在兰州非遗陈列馆，我们观看了皮影戏传承人的现场表演《西游记·三打白骨精》。随后走进后台，五根竹签控制一个人物的全身动作，令人惊叹。传承人展示了不同年代制作的皮影，从民国时期的牛皮老件到近年新作，并介绍了选皮、浸泡、刮毛、雕刻、上色、装订的制作流程。',
            feeling: '幕布前的皮影活灵活现，幕布后的艺人汗流浃背。一根竹签的微小动作需要数年练习才能精准控制。灯光熄灭、皮影收起时，我们感受到的不是落幕，而是一种古老艺术与时间赛跑的紧迫感。'
          },
          { name: '兰州面塑', level: '市级非遗', description: '指尖揉捏百态，传统美术活化石，民俗节庆不可或缺的艺术形式。', image: 'https://picsum.photos/seed/heritage-miansu/400/300', icon: '🤲',
            intro: '兰州面塑以小麦面粉为主料，通过揉、捏、搓、压、剪等手法塑造人物和动物形象。面塑源于民间祭祀和节庆习俗，后发展为独立民间美术形式，题材涵盖神话传说、历史人物和现实生活。',
            process: '在传承人工作室，我们观摩了面塑的完整制作过程——开脸、做手、穿衣等关键步骤。完成一件面塑作品通常需要两到三天。我们尝试捏制简单的小动物，面粉在指尖的触感柔软而有韧性，但要塑出形态非常困难。',
            feeling: '面塑被称为"指尖上的雕塑"。传承人那双粗糙却灵巧的手，几分钟就让一团面变成了栩栩如生的人物。我们捏的小兔子歪歪扭扭，但传承人说"喜欢就好，面塑本来就是给人带来快乐的"。那一刻我们懂了——非遗的温度，在于它连接人心的力量。'
          },
          { name: '兰州刺绣', level: '市级非遗', description: '丝线穿梭古今，一针一线绣山河，色彩浓烈、图案质朴。', image: 'https://picsum.photos/seed/heritage-cixiu/400/300', icon: '🧵',
            intro: '兰州刺绣（陇绣）以棉布或丝绸为底料，用彩色丝线绣制图案。针法包括平针绣、剁绣、打籽绣等十余种，图案以花鸟、山水、吉祥纹样为主，色彩浓烈、风格质朴，承载着陇原女性的生活情感与审美追求。',
            process: '在刺绣工坊，传承人展示了不同针法的效果——平针绣光洁平滑、剁绣立体饱满、打籽绣颗粒分明。我们每人分到一块绣布和针线，尝试平针绣一朵简单的兰花。穿针引线看似简单，但要让每一针都均匀平直非常困难，传承人逐一纠正我们的针法和坐姿。',
            feeling: '刺绣时的寂静让人沉浸——只有针穿过布面的细微声响。我们绣了半小时就肩酸眼花，而传承人每天要绣八小时以上。她说"刺绣是养心的"，一针一线中藏着对美的执着和对时间的敬意。'
          }
        ],
        practicePhotos: [
