    ...
    points: [
      {
        ...
        heritageItems: [
          ...
          { name: '兰州泥塑', level: '省级非遗', description: '以黄河红胶泥为原料，捏塑市井百态，被誉为"立体的兰州老照片"。', image: 'C:\\Users\\MECHREVO\\OneDrive\\Desktop\\社会实践网站\\image\\泥塑.jpg', icon: '🤲',
      ...
      },
      {
        ...
        heroImage: 'C:\\Users\\MECHREVO\\OneDrive\\Desktop\\社会实践网站\\image\\临夏.jpg',
        description: '花儿之乡，彩陶故里，河州文化发源地',
        surveyAreas: [
          { name: '临夏州博物馆', description: '马家窑彩陶 · 齐家玉器 · 黄河上游文明', image: 'https://picsum.photos/seed/linxia-museum/600/400',
          ...
          { name: '八坊十三巷', description: '4A景区 · 回族民居 · 非遗活态传承', image: 'https://picsum.photos/seed/bafang-xiang/600/400',
          ...
          { name: '红园（八门拳）', description: '传统园林 · 武术传承 · 八门拳活态基地', image: 'https://picsum.photos/seed/hongyuan-bamen/600/400',
        ...
        heritageItems: [
          { name: '河州刺绣', level: '省级非遗', description: '针法细腻、色彩明快，承载回族妇女的生活情感与审美。', image: 'https://picsum.photos/seed/hezhou-xiu/400/300', icon: '🧵',
          ...
          { name: '临夏酿皮子', level: '省级非遗', description: '回族风味小吃，制作工艺讲究，料汁配方代代相传。', image: 'https://picsum.photos/seed/niangpizi/400/300', icon: '🍜',
          ...
          { name: '蛋雕', level: '市级非遗', description: '在薄如蝉翼的蛋壳上雕刻，讲究极致的耐心与力度。', image: 'https://picsum.photos/seed/dandiao/400/300', icon: '🥚',
          ...
          { name: '临夏砖雕', level: '国家级非遗', description: '以青砖为材料，刀笔之下生花，西北独特的建筑语言。', image: 'https://picsum.photos/seed/linxia-zhuandiao/400/300', icon: '🧱',
          ...
          { name: '河州包子', level: '市级非遗', description: '传统回族面点，皮薄馅大，三代传承纯手工制作。', image: 'https://picsum.photos/seed/hezhou-baozi/400/300', icon: '🥟',
          ...
          { name: '八门拳', level: '省级非遗', description: '临夏传统武术，动作干脆利落、攻防兼备，传承百年。', image: 'https://picsum.photos/seed/bamenquan/400/300', icon: '🥋',
