  ...
  gansu: {
    ...
    points: [
      ...
      },
      {
        ...
        practicePhotos: [
          { label: '孩子们体验蛋雕展示', image: 'image/支教1(1).jpg' },
          { label: '八门拳武术操教学', image: 'image/支教2(1).jpg' },
          { label: '泥塑彩陶体验课', image: 'image/支教3(1).jpg' }
        ],
        insight: '五节课，五天时间，我们带去的不是多么高深的知识，而是一扇窗。砖雕的纹路、蛋壳上的雕刻、拳法的利落、彩陶上的漩涡——这些东西离孩子们的生活其实并不远，只是没有人告诉他们"这很珍贵"。当他们小心翼翼地捧着蛋雕、满头大汗地练拳、为捏出来的歪扭作品欢呼雀跃时，我们看到了非遗在下一代心中种下的种子。有个小姑娘在最后一天拉着我们问"你们明年还来吗"，那一刻所有熬夜备课的疲惫都值了。支教让我们明白：传承不是把老东西锁进玻璃柜，而是让它成为孩子们眼中的光、手中的温度、心里的骄傲。',
