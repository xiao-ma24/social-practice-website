  ...
  gansu: {
    ...
    points: [
      ...
      },
      {
        ...
        insight: '在临夏的每一天，我们都在被不同的手艺和手艺人的故事触动。博物馆里马玲老师说"文物不能老藏在库房里"，八坊十三巷里老奶奶看到年轻人关心刺绣时眼里藏着光，酿皮子店老板凌晨起来做皮子几十年从未觉得烦，砖雕工匠们不怎么说话但手上在说话，蛋雕师傅一句"十几年"轻描淡写带过多少个日夜的冷板凳，马建新老师说手艺是"从心里长出来的"。还有红园里练了一辈子八门拳的老师傅们，不想让手艺断在自己手里。我们帮河州包子店整理申遗材料时一字一句斟酌，觉得这不只是完成任务——是在守护一种味道、一段记忆。临夏让我们明白：非遗不是挂在墙上的荣誉牌，而是一个个活生生的人用一生在做的事。"各美其美，美美与共"，在这座多元文化交融的城市里，我们真切地感受到了这句话的分量。',
        ...
        heritageItems: [
          ...
          { name: '蛋雕', level: '市级非遗', description: '在薄如蝉翼的蛋壳上雕刻，讲究极致的耐心与力度。', image: 'image\\蛋雕2.jpg', icon: '🥚',
      ...
      },
      {
        ...
        insight: '在天水，我们触摸到了中华文明最古老的脉搏。大地湾八千年前的灶坑里，先民曾在此生火做饭；彩陶上流畅的漩涡纹，是远古艺术家一笔一划的呼吸。邵主任说"文物不能老藏在库房里"，这句话让我们深受触动——文明的传承不在于把文物封存于展柜，而在于让每一个路过的人都能感受到八千年前的那缕炊烟、那条曲线。亲手临摹彩陶纹样时，我们画得歪歪扭扭，才真正懂得古人的技艺有多高超。天水之行让我们理解：文化自信不是口号，而是源于对自己文明源头真切的触摸与感知。那一天的黄土台地上风很大，但历史的温度，暖到心里。',
        heroImage: 'image\\天水.jpg',
        description: '羲皇故里，麦积烟雨，大地湾八千年文明曙光',
        surveyAreas: [
          { name: '大地湾博物馆', description: '史前文明 · 彩陶源头 · 八千年中华文明曙光', image: 'image\\大地湾博物馆.png',
            intro: '大地湾遗址距今8000-4800年，是中国新石器时代最重要的考古发现之一，被誉为"中华文明的曙光"。大地湾博物馆集中展示了遗址出土的彩陶、骨器、玉器、地面等珍贵文物，涵盖了仰韶文化早中晚期，完整呈现了黄河流域先民的聚落形态与艺术创造力。',
            process: '专访邵主任，他生动讲解"小祖宗"文创等创新举措，说"文物不能老藏在库房里"。他如数家珍地介绍每一件文物背后的故事，兴奋地说要让博物馆成为年轻人的打卡地。参观展厅后进入遗址公园，走在黄土台地上，看着几千年前的房屋基址和灶坑，风很大，但历史的厚重感让人不敢大声说话。',
            feeling: '站在八千年前先民生火做饭的地方，课本上的"史前文明"变得具体而滚烫。邵主任的热情也感染了我们——他不只是在工作，是真的爱这些文物。保护不是供起来，而是让它在今天仍被看见、被讨论。那一刻我们明白，文明的传承不在于把文物封存，而在于让每一个路过的人都能感受到八千年前的那缕炊烟。'
          }
        ],
        heritageItems: [
          { name: '彩陶（马家窑文化）', level: '国家级非遗', description: '马家窑文化彩陶巅峰之作，纹样精美被誉为史前艺术瑰宝。', image: 'https://ts1.tc.mm.bing.net/th/id/R-C.d2b3d38216f8ac7b8ae8796a666c7564?rik=35rbknIfDM9JzQ&riu=http%3a%2f%2fn.sinaimg.cn%2fsinacn%2fw2048h2048%2f20171228%2f3131-fypyuve1448284.jpg&ehk=aUoFWHL5xufhQhznjhfRtLFhpKzLfImmkzXMAQW8JJI%3d&risl=&pid=ImgRaw&r=0', icon: '🏺',
            intro: '以马家窑文化为代表的大地湾彩陶，是中国彩陶艺术的巅峰。距今约5000年的马家窑先民在陶器上绘制漩涡纹、网格纹、蛙纹等精美图案，有的内壁也有纹饰——被称为"通体彩绘"，极为罕见，展现了古人惊人的审美与技艺。',
            process: '系统观察彩陶文物，记录纹样类型与演变，请教制作工艺。讲解员指着展柜中一件内壁绘满纹饰的彩陶说，这是"通体彩绘"，全国都罕见。我们凑近玻璃仔细观察每一道线条——流畅、自信、有呼吸感。随后尝试临摹这些古老纹样，发现看似简单的曲线自己画出来却呆板得多。',
            feeling: '几千年前的线条今天看依然有生命力——不是机械复制，而是有呼吸、有节奏的创作。我们试着临摹，发现自己画得呆板得多。古人的审美和手艺，远比我们想象的高超。那些漩涡纹就像黄河的水在陶罐上流淌，几千年都没停过。'
          }
        ],
        practicePhotos: [
          { label: '采访大地湾遗址考古专家邵主任', image: 'image\\采访大地湾.jpg' },
          { label: '小队参观大地湾博物馆', image: 'image\\大地湾.png' },
          { label: '大地湾文化遗址', image: 'image\\遗址.jpg' },
          { label: '体验彩陶制作', image: 'image\\微信图片_20260609200818_423_275.png' }
        ],
      ...
      },
      {
        ...
        isTeaching: true,
        teachingActivities: [
          { name: '砖雕与蛋雕文化宣传课', description: '用图片视频展示砖雕蛋雕工艺，带仿制品让孩子们近距离感受非遗之美。', image: 'image\\蛋雕.jpg',
          ...
          { name: '八门拳武术操', description: '改编简易武术操，操场教学，孩子们从歪歪扭扭到整齐有力。', image: 'image\\八门拳教学.jpg',
          ...
          { name: '泥塑彩陶体验课', description: '用橡皮泥代替陶泥，讲彩陶纹样后让孩子自由创作，脑洞大开。', image: 'image\\泥塑.jpg',
          ...
          { name: '非遗文化大富翁游戏', description: '自主设计桌游，掷骰子抽知识问答和任务卡，寓教于乐学非遗。', image: 'image\\大富翁.png',
          ...
          { name: '河州刺绣与剪纸体验课', description: '一针一线学刺绣，一剪一纸做窗花，让孩子们亲手体验传统手工艺。', image: 'image\\刺绣2.jpg',
        ...
        practicePhotos: [
          { label: '王尹镇中心小学暑期全体学生合影', image: 'image//支教3.jpg' },
          { label: '课堂小游戏', image: 'image//支教2.jpg' },
          { label: '向孩子们展示非遗蛋雕', image: 'image//展示.jpg' }
        ],
        insight: '十节课，五天时间，我们带去的不是多么高深的知识，而是一扇窗。砖雕的纹路、蛋壳上的雕刻、拳法的利落、彩陶上的漩涡——这些东西离孩子们的生活其实并不远，只是没有人告诉他们"这很珍贵"。当他们小心翼翼地捧着蛋雕、满头大汗地练拳、为捏出来的歪扭作品欢呼雀跃时，我们看到了非遗在下一代心中种下的种子。有个小姑娘在最后一天拉着我们问"你们明年还来吗"，那一刻所有熬夜备课的疲惫都值了。支教让我们明白：传承不是把老东西锁进玻璃柜，而是让它成为孩子们眼中的光、手中的温度、心里的骄傲。',
